...
//         ];
        ...
        $workpackages = [
            // Kategori 1: Perencanaan
            [
                'category_id' => 1,
                'wp_number' => '1.1',
                'name' => 'Analisis Kebutuhan Bisnis (Business Requirement Analysis)',
                'volume_qty' => 1,
                'duration' => 25, // hari
                'actual_scope_contract' => 'Hanya mencakup analisis untuk modul CRM dan Inventory. Di luar Modul Keuangan.',
                'deliverable' => 'Dokumen Analisis Kebutuhan Bisnis (BRD).'
            ],
            [
                'category_id' => 1,
                'wp_number' => '1.2',
                'name' => 'Pembuatan Rencana Proyek Awal (Initial Project Plan)',
                'volume_qty' => 1,
                'duration' => 12, // hari
                'actual_scope_contract' => '', // Dikosongkan
                'deliverable' => 'Dokumen Rencana Proyek (Project Charter).'
            ],

            // Kategori 2: Desain & Pengembangan
            [
                'category_id' => 2,
                'wp_number' => '2.1',
                'name' => 'Perancangan Arsitektur Sistem (System Architecture Design)',
                'volume_qty' => 1,
                'duration' => 30, // hari
                'actual_scope_contract' => 'Desain menggunakan teknologi Microservices dengan database PostgreSQL.',
                'deliverable' => 'Dokumen Arsitektur Sistem dan Desain Teknis.'
            ],
            [
                'category_id' => 2,
                'wp_number' => '2.2',
                'name' => 'Pengembangan Modul Inti (Core Module Development)',
                'volume_qty' => 3,
                'duration' => 85, // hari
                'actual_scope_contract' => '', // Dikosongkan
                'deliverable' => 'Kode sumber (Source Code) Modul Inti yang berfungsi.'
            ],

            // Kategori 3: Pengujian Kualitas
            [
                'category_id' => 3,
                'wp_number' => '3.1',
                'name' => 'Pengujian Fungsionalitas (Functional Testing)',
                'volume_qty' => 2,
                'duration' => 20, // hari
                'actual_scope_contract' => 'Pengujian dilakukan oleh tim QA internal dan 5 user terpilih (UAT).',
                'deliverable' => 'Laporan Hasil Uji Fungsionalitas dan Daftar Bug.'
            ],

            // Kategori 4: Pemasaran & Promosi
            [
                'category_id' => 4,
                'wp_number' => '4.1',
                'name' => 'Pembuatan Materi Pemasaran Digital (Digital Marketing Collateral)',
                'volume_qty' => 3,
                'duration' => 15, // hari
                'actual_scope_contract' => '', // Dikosongkan
                'deliverable' => 'Desain aset promosi (banner, video pendek, konten media sosial).'
            ],
            [
                'category_id' => 4,
                'wp_number' => '4.2',
                'name' => 'Kampanye Peluncuran Produk (Product Launch Campaign Execution)',
                'volume_qty' => 1,
                'duration' => 40, // hari
                'actual_scope_contract' => 'Target audiens kampanye adalah wilayah Jawa Barat dan Banten, dengan fokus pada media sosial.',
                'deliverable' => 'Laporan Kinerja Kampanye dan metrik engagement.'
            ],
            ...
            [
                'category_id' => 5,
                'wp_number' => '5.1',
                'name' => 'Penyusunan Anggaran Proyek (Project Budget Drafting)',
                'volume_qty' => 1,
                'duration' => 10, // hari
                'actual_scope_contract' => '', // Dikosongkan
                'deliverable' => 'Dokumen Anggaran Proyek yang disetujui.'
            ],

            // Kategori 6: Dukungan Teknis
            [
                'category_id' => 6,
                'wp_number' => '6.1',
                'name' => 'Penyusunan Dokumentasi Pengguna (User Documentation)',
                'volume_qty' => 2,
                'duration' => 25, // hari
                'actual_scope_contract' => 'Dokumentasi hanya dibuat dalam format PDF dan video tutorial singkat.',
                'deliverable' => 'Manual Pengguna dan FAQ.'
            ],
            [
                'category_id' => 6,
                'wp_number' => '6.2',
                'name' => 'Pengaturan Lingkungan Produksi (Production Environment Setup)',
                'volume_qty' => 1,
                'duration' => 18, // hari
                'actual_scope_contract' => '', // Dikosongkan
                'deliverable' => 'Laporan Konfigurasi Server/Layanan Cloud.'
            ],

            // Kategori 7: Administrasi
            [
                'category_id' => 7,
                'wp_number' => '7.1',
                'name' => 'Pengurusan Izin dan Legalitas Proyek (Permit and Legalization)',
                'volume_qty' => 1,
                'duration' => 60, // hari
                'actual_scope_contract' => 'Pengurusan Izin Mendirikan Bangunan (IMB) dan Amdal saja.',
                'deliverable' => 'Salinan izin/dokumen legalitas yang sah.'
            ],

            // Kategori 8: Riset & Analisis
            [
                'category_id' => 8,
                'wp_number' => '8.1',
                'name' => 'Survei Kepuasan Pengguna (User Satisfaction Survey)',
                'volume_qty' => 3,
                'duration' => 35, // hari
                'actual_scope_contract' => '', // Dikosongkan
                'deliverable' => 'Laporan Hasil Survei dan Analisis Data.'
            ],

            // Kategori 9: Pelatihan & SDM
            [
                'category_id' => 9,
                'wp_number' => '9.1',
                'name' => 'Penyelenggaraan Pelatihan Pengguna Akhir (End-User Training)',
                'volume_qty' => 2,
                'duration' => 14, // hari
                'actual_scope_contract' => 'Pelatihan diselenggarakan secara daring (online) untuk 50 peserta.',
                'deliverable' => 'Materi pelatihan dan Daftar Hadir Peserta.'
            ],

            // Kategori 10: Operasi Lapangan
            [
                'category_id' => 10,
                'wp_number' => '10.1',
                'name' => 'Instalasi Perangkat Keras di Lokasi Klien (On-Site Hardware Installation)',
                'volume_qty' => 3,
                'duration' => 50, // hari
                'actual_scope_contract' => 'Instalasi di 3 lokasi cabang utama di area Jabodetabek.',
                'deliverable' => 'Berita Acara Instalasi (BAI) yang ditandatangani.'
            ]
        ];
