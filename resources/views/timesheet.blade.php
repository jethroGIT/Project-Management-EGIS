        ...
        <div class="card-body">
            ...
            <div class="col">
                <div class="d-flex justify-content-between mb-5">
                    ...
                    <button type="button" class="btn btn-light-primary" aria-expanded="false" aria-controls="kelolaAktivitas" onclick="window.location.href='{{ route('timesheet.detail.user', [$volume->volume_id, auth()->user()->user_id]) }}'">
                        Kelola Aktivitas
