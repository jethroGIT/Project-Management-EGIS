                ...
                <table id="tabel_resource" class="table table-striped gy-4 gs-3 border rounded w-100">
                    <thead>
                        <tr class="fw-bolder fs-6 text-gray-800 px-7">
                            ...
                            <th class="align-middle border-bottom min-w-100px">Nama</th>
                            <th class="align-middle border-bottom">Email</th>
                            <th class="align-middle border-bottom min-w-200px">Deskripsi</th>
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (response.success) {
                ...
                $('#editUserDesc').val(response.user.desc);
...
function submitEditUser() {
    ...
    const originalData = {
        ...
        desc: $('#editUserDesc').data('original') || $('#editUserDesc').val(),
